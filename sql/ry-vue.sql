...
) ENGINE = InnoDB AUTO_INCREMENT = 134 CHARACTER SET = utf8 COLLATE = utf8_general_ci COMMENT = '通知公告表' ROW_FORMAT = DYNAMIC;
...
INSERT INTO `sys_user` VALUES (110, 301, 'teacher', '王笑笑', '00', 'teacher@test.com', '13800138001', '1', '', '$2a$10$Ru303og8WriTAkDRd0jyv.9ryYQysA1FVJxYhhd.KlcALjZFInDBS', '0', '0', '127.0.0.1', '2026-05-11 23:37:03', NULL, 'admin', '2026-04-20 17:31:07', 'admin', '2026-05-24 15:48:00', NULL);
INSERT INTO `sys_user` VALUES (111, 103, 'warehouse', '库管员', '00', 'warehouse@test.com', '13800138002', '1', '', '$2a$10$7JB720yubVSZvUI0rEqK/.VqGOZTH.ulu33dHOiBE8ByOhJIrdAu2', '0', '0', '127.0.0.1', '2026-05-25 00:32:09', NULL, 'admin', '2026-04-20 17:31:07', 'admin', '2026-05-25 00:32:09', NULL);
INSERT INTO `sys_user` VALUES (112, 308, 'supplier', '工业出版社', '00', '', '13800138003', '1', '', '$2a$10$7JB720yubVSZvUI0rEqK/.VqGOZTH.ulu33dHOiBE8ByOhJIrdAu2', '0', '0', '127.0.0.1', '2026-05-24 23:37:31', NULL, 'admin', '2026-04-20 17:31:07', 'warehouse', '2026-05-24 23:37:31', NULL);
...
INSERT INTO `sys_user` VALUES (115, NULL, 'SUP002', '人民出版社', '00', '', '', '0', '', '$2a$10$HMl5/ESpSl1XpqHZFZp2TeGbRrYhKjrToaOEeoDF3TcEomo0aGNQm', '0', '0', '127.0.0.1', '2026-05-24 20:20:59', NULL, 'warehouse', '2026-05-24 20:20:43', '', '2026-05-24 20:20:58', NULL);
...
) ENGINE = InnoDB AUTO_INCREMENT = 8 CHARACTER SET = utf8mb4 COLLATE = utf8mb4_0900_ai_ci COMMENT = '采购单(教材采购)' ROW_FORMAT = DYNAMIC;
...
) ENGINE = InnoDB AUTO_INCREMENT = 11 CHARACTER SET = utf8mb4 COLLATE = utf8mb4_0900_ai_ci COMMENT = '领书单表' ROW_FORMAT = DYNAMIC;
...
INSERT INTO `textbook_claim_form` VALUES (66, 'CF2026052500481992d7cd', 7, 0, 0, 0, '25级机械', '25级', '0', 30, 0, NULL, NULL, '', '2026-05-25 00:48:19', '', NULL, '0', NULL, NULL);
...
INSERT INTO `textbook_claim_form` VALUES (70, 'CF202605250048191510e9', 7, 0, 0, 0, '25级人文', '25级', '0', 30, 0, NULL, NULL, '', '2026-05-25 00:48:19', '', NULL, '0', NULL, NULL);
...
) ENGINE = InnoDB AUTO_INCREMENT = 39 CHARACTER SET = utf8mb4 COLLATE = utf8mb4_0900_ai_ci COMMENT = '领书单明细表' ROW_FORMAT = DYNAMIC;
...
INSERT INTO `textbook_claim_form_detail` VALUES (128, 66, 41, '9787302362371', '大学物理学（第三版）C6版 上册', NULL, NULL, NULL, 30, 0, '2026-05-25 00:48:19', '', '', NULL, '0');
...
INSERT INTO `textbook_claim_form_detail` VALUES (133, 70, 1, '9787040589818', '高等数学（第八版）上册', NULL, NULL, NULL, 30, 0, '2026-05-25 00:48:19', '', '', NULL, '0');
...
) ENGINE = InnoDB AUTO_INCREMENT = 9 CHARACTER SET = utf8mb4 COLLATE = utf8mb4_0900_ai_ci COMMENT = '缺书登记表' ROW_FORMAT = DYNAMIC;
...
) ENGINE = InnoDB AUTO_INCREMENT = 3 CHARACTER SET = utf8mb4 COLLATE = utf8mb4_0900_ai_ci COMMENT = '领书通知表' ROW_FORMAT = DYNAMIC;
...
INSERT INTO `textbook_notice` VALUES (7, 'LS20260525004816913D10', '2025-2026-2', '2026-04-07 00:00:00', '2026-05-31 00:00:00', '二教', '1', 10, 0, 'warehouse', '2026-05-25 00:48:16', '', '2026-05-25 00:57:28', '0', NULL, NULL, NULL, NULL);
...
CREATE TABLE `textbook_purchase_detail`  (
  ...
  INDEX `idx_book_id`(`book_id`) USING BTREE
) ENGINE = InnoDB AUTO_INCREMENT = 70 CHARACTER SET = utf8mb4 COLLATE = utf8mb4_0900_ai_ci COMMENT = '购书明细表' ROW_FORMAT = DYNAMIC;
...
) ENGINE = InnoDB AUTO_INCREMENT = 59 CHARACTER SET = utf8mb4 COLLATE = utf8mb4_0900_ai_ci COMMENT = '库存表' ROW_FORMAT = DYNAMIC;

-- ----------------------------
-- Records of textbook_stock
-- ----------------------------
INSERT INTO `textbook_stock` VALUES (1, 1, 30, NULL, 10, '2026-05-24 23:45:29', '0', 'normal', 0, 0, 0, '', '2026-05-24 23:45:29', '');
...
INSERT INTO `textbook_stock` VALUES (14, 41, 30, NULL, 10, '2026-05-24 23:45:29', '0', 'normal', 0, 0, 0, '', '2026-05-24 23:45:29', '');
