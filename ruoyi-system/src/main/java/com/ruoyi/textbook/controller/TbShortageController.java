...
public class TbShortageController extends BaseController
{
     ...
     * 新增缺书登记信息
     */
    @PreAuthorize("@ss.hasPermi('textbook:shortage:add') and @ss.hasAnyRole('admin','issuer','purchaser')")
    @PostMapping
     ...
     * 修改缺书登记信息
     */
    @PreAuthorize("@ss.hasPermi('textbook:shortage:edit') and @ss.hasAnyRole('admin','issuer','purchaser')")
    @PutMapping
     ...
     * 删除缺书登记信息
     */
    @PreAuthorize("@ss.hasPermi('textbook:shortage:remove') and @ss.hasAnyRole('admin','issuer','purchaser')")
     ...
     * 处理缺书
     */
    @PreAuthorize("@ss.hasPermi('textbook:shortage:process') and @ss.hasAnyRole('admin','issuer','purchaser')")
