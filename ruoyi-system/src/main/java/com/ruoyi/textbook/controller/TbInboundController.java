...
public class TbInboundController extends BaseController
{
     ...
     * 新增入库信息
     */
    @PreAuthorize("@ss.hasPermi('textbook:inbound:add') and @ss.hasAnyRole('admin','purchaser')")
    @PostMapping
     ...
     * 修改入库信息
     */
    @PreAuthorize("@ss.hasPermi('textbook:inbound:edit') and @ss.hasAnyRole('admin','purchaser')")
    @PutMapping
     ...
     * 删除入库信息
     */
    @PreAuthorize("@ss.hasPermi('textbook:inbound:remove') and @ss.hasAnyRole('admin','purchaser')")
     ...
     * 处理教材入库
     */
    @PreAuthorize("@ss.hasPermi('textbook:inbound:process') and @ss.hasAnyRole('admin','purchaser')")
    @PostMapping("/process")
